...
public class Main {
    ...
    public static Connection getConnection() {
        ...
        try {
            postGresConn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres", "postgres", "root");
            //connection = DriverManager.getConnection("jdbc:postgresql://pgsql2.mif/studentu", "igja2218", "igja2218") ;
